...
This project is suitable for beginners and is built as part of an internship / academic submission to demonstrate practical Python programming skills.
...
Apply Python OOP principles in a real-world project
...
📂 Project Structure
Python-Personal-Finance-Manager/ │ ├── README.md ├── requirements.txt ├── main.py │ ├── src/ │ ├── init.py │ ├── expense.py │ ├── file_manager.py │ ├── reports.py │ ├── menu.py │ └── utils.py │ ├── data/ │ └── expenses.csv │ ├── docs/ │ └── user_guide.md │ ├── tests/ │ └── test_basic.py │ └── screenshots/ ├── menu.png ├── add_expense.png └── report.png
...
Basic test cases can be found in the tests/ directory. Testing is optional for this version but can be extended in future updates.
